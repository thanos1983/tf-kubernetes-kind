output "generation" {
  ...
  value       = kubernetes_cluster_role_binding_v1.cluster_role_binding_v1.generation
}
...
output "resource_version" {
  ...
  value       = kubernetes_cluster_role_binding_v1.cluster_role_binding_v1.resource_version
}

output "uid" {
  description = "The unique in time and space value for this cluster role binding."
  value       = kubernetes_cluster_role_binding_v1.cluster_role_binding_v1.uid
}